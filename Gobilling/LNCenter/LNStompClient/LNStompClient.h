...
@protocol LNStompSubscriptionIdGenerator <NSObject>

- (NSString *)generateId;

@end

@interface LNStompFrame : NSObject
...
@interface LNStompMessage : LNStompFrame
...
@interface LNStompSubscription : NSObject
