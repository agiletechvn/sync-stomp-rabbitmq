...
@interface FoodCategoryTableViewCell ()
...
- (void)updateWithFoodCategory:(DNFoodCategory *)foodCategory
{
    ...
    self.titleLabel.text = foodCategory.name;
    self.commentCountLabel.text = [NSString stringWithFormat:@"%@ foods", foodCategory.foodCount];
    self.updatedLabel.text = @"28/05/2015";//foodCategory.userId.stringValue;
}
